...
export const InlineEdit: React.FC<InlineEditProps> = ({
  ...
  if (isEditing) {
    const defaultInputClasses = "bg-white/20 border border-white/30 rounded px-2 py-1 text-white placeholder-slate-300 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-white/50 backdrop-blur-sm w-full min-w-0";
    const inputClasses = className.includes('w-full') ? `${defaultInputClasses} ${className}` : `${defaultInputClasses} ${className}`;

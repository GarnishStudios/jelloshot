...
interface CrewSectionProps {
  ...
  onAddMember: (member: Partial<CrewMember>) => void;
  onUpdateMember: (id: string, updates: Partial<CrewMember>) => void;
        ...
        <>
          {crewMembers.length === 0 ? (
            <div className="text-center py-8">
              <p className="text-slate-300 mb-4">No crew members added yet</p>
              <Button
                onClick={handleAddMember}
                className="gap-2 bg-emerald-600 hover:bg-emerald-700 text-white border-0"
              >
